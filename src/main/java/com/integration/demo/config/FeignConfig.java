...
public class FeignConfig {
    ...
    @Bean
    Logger logger() { return new Slf4jLogger(FeignConfig.class);}

    @Bean
    public Request.Options options() { return new Request.Options(connectTimeout, readTimeOut);}
